...
--     end
--     -- vim.keymap.set("n", "tr", api.tree.reload, opts("Refresh"))
--
--     -- open / close --
--     -- vim.keymap.set("n", "to", api.node.open.edit, opts("Open"))
--     -- vim.keymap.set("n", "tc", api.node.navigate.parent_close, opts("Close Directory"))
