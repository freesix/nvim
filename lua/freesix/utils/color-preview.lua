...
local function next_color(prompt_buffer)
  ...
  local selected = action_state.get_selected_entry()
  require("freesix").config.colorscheme = selected[1]
  package.loaded["freesix.plugins.lualine"] = nil
...
vim.api.nvim_create_user_command("FreesixColorPreview", colorPreview, {})
